...
#include "TidelibAlamedaSanFranciscoBayCalifornia.h"
...
float curTide; // results holds the output from the tide calc. Units = ft.

//*******************************************************************
// Welcome to the setup loop

void tide_setup(void)
    {
    Wire.begin();
    RTC.begin();
    ...
    Serial.println(F("Calculating tides for: "));
    ...
    curTide = myTideCalc.currentTide(now);

    //*****************************************
    // For debugging
    Serial.print(F("Tide height: "));
    Serial.print(curTide, 3);
    Serial.println(F(" ft."));
